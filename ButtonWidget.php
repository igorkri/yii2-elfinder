...
class ButtonWidget extends Widget{
	...
	public function run(){
		...
		$this->getView()->registerJs("igorkri.elFinder.register(" . Json::encode($this->_managerOptions['id']) . ", " . Json::encode($this->callback) . ");"); // register callback Function
		$this->getView()->registerJs("\$(document).on('click', '#" . $this->options['id'] . "', function(){igorkri.elFinder.openManager(" . Json::encode($this->_managerOptions) . ");});");//on click button open manager
	}
}