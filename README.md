...
igorkri/yii2-elfinder-flysystem - https://github.com/igorkri/yii2-elfinder-flysystem/
...
```
php composer.phar require --prefer-dist igorkri/yii2-elfinder "*"
```

или добавить

```json
"igorkri/yii2-elfinder": "*"
```
...
'controllerMap' => [
        'elfinder' => [
            'class' => 'igorkri\elfinder\Controller',
            ...
            'roots' => [
                ...
                [
                    'class' => 'igorkri\elfinder\volume\UserPath',
                    'path'  => 'files/user_{id}',
                    'name'  => 'My Documents'
                ],
                [
...
На данный момент реализованно использование только LocalFileSystem хранилища (igorkri\elfinder\volume\Local и igorkri\elfinder\volume\UserPath)
для использования остальных вам прийдётся всё настраивать через igorkri\elfinder\volume\Base
также добавленно расширение  https://github.com/igorkri/yii2-elfinder-flysystem/ это дополнение позволяет интегрировать Flysystem хранилища такие как
    Local
    Azure
    AWS S3 V2
    AWS S3 V3
...
'controllerMap' => [
        'elfinder' => [
            'class' => 'igorkri\elfinder\Controller',
            //'plugin' => ['\igorkri\elfinder\plugin\Sluggable'],
            'plugin' => [
                [
...
```php
use igorkri\elfinder\InputFile;
...
Использование совместно с приложением "igorkri/yii2-ckeditor" (https://github.com/igorkri/yii2-ckeditor)
...
igorkri\elfinder\Assets::noConflict($this);
...
https://github.com/igorkri/yii2-elfinder-flysystem/
